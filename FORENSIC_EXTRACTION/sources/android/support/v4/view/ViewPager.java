...
public class ViewPager extends ViewGroup {
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i, ItemInfo itemInfo2) {
        ...
        if (itemInfo2 != null) {
            ...
            if (i2 < itemInfo.position) {
                ...
                while (true) {
                    float pageWidth = f2;
                    if (i3 > itemInfo.position || i4 >= this.mItems.size()) {
                        break;
                    }
                ...
                int i5 = i2 - 1;
                int i6 = size;
                while (i5 >= itemInfo.position && i6 >= 0) {
                    ItemInfo itemInfo6 = this.mItems.get(i6);
                    while (true) {
                        itemInfo3 = itemInfo6;
                        if (i5 >= itemInfo3.position || i6 <= 0) {
                            break;
                        }
                        i6--;
                        itemInfo6 = this.mItems.get(i6);
                    }
                    while (i5 > itemInfo3.position) {
                        pageWidth2 -= this.mAdapter.getPageWidth(i5) + f;
                        i5--;
                    }
                    float f3 = pageWidth2 - (itemInfo3.widthFactor + f);
                    itemInfo3.offset = f3;
                    i5--;
                    pageWidth2 = f3;
                }
        ...
        for (int i8 = i - 1; i8 >= 0; i8--) {
            ...
            while (i7 > itemInfo7.position) {
                pageWidth3 -= this.mAdapter.getPageWidth(i7) + f;
                i7--;
            }
    ...
    private ItemInfo infoForCurrentScrollPosition() {
        ...
        while (i2 < this.mItems.size()) {
            ...
            if (scrollX < f5 + f4 + f || i2 == this.mItems.size() - 1) {
                return itemInfo;
            }
            i = itemInfo.position;
            i2++;
    ...
    private boolean pageScrolled(int i) {
        ...
        float f2 = ((i / clientWidth) - itemInfoInfoForCurrentScrollPosition.offset) / (itemInfoInfoForCurrentScrollPosition.widthFactor + f);
        this.mCalledSuper = false;
    ...
    public void fakeDragBy(float f) {
        ...
        ItemInfo itemInfo = this.mItems.get(0);
        ItemInfo itemInfo2 = this.mItems.get(this.mItems.size() - 1);
        float f6 = itemInfo.position != 0 ? itemInfo.offset * clientWidth : f2 * f3;
        float f7 = itemInfo2.position != this.mAdapter.getCount() + (-1) ? itemInfo2.offset * clientWidth : f4 * f5;
        if (scrollX >= f6) {
                ...
                if (layoutParams.isDecor) {
                    ...
                    switch (i10 & 7) {
                        ...
                        default:
                            ...
                            break;
                        case 3:
                            measuredWidth2 = paddingLeft + childAt.getMeasuredWidth();
                            iMax = paddingLeft;
                            measuredWidth = paddingRight;
                            break;
                        case 5:
                            ...
                            iMax = (i6 - paddingRight) - measuredWidth3;
                            measuredWidth2 = paddingLeft;
                            break;
                    }
                    switch (i11 & com.tiket.git.R.styleable.AppCompatTheme_seekBarStyle) {
                        case 16:
        ...
        for (int i14 = 0; i14 < childCount; i14++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor && (itemInfoInfoForChild = infoForChild(childAt2)) != null) {
                    int i15 = ((int) (itemInfoInfoForChild.offset * i13)) + paddingLeft;
                    if (layoutParams2.needsMeasure) {
                        layoutParams2.needsMeasure = false;
                        childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (layoutParams2.widthFactor * i13), 1073741824), View.MeasureSpec.makeMeasureSpec((i7 - paddingTop) - paddingBottom, 1073741824));
                    }
    ...
    /* JADX WARN: Code duplicated, block: B:52:0x010c A[PHI: r2
      0x010c: PHI (r2v5 int) = (r2v4 int), (r2v7 int) binds: [B:28:0x0088, B:30:0x008f] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (i5 < childCount) {
            ...
            if (childAt.getVisibility() == 8 || (layoutParams2 = (LayoutParams) childAt.getLayoutParams()) == null || !layoutParams2.isDecor) {
                ...
                int i7 = layoutParams2.gravity & com.tiket.git.R.styleable.AppCompatTheme_seekBarStyle;
    ...
    void populate(int i) {
        ...
        if (getWindowToken() != null) {
            ...
            int count = this.mAdapter.getCount();
            int iMin = Math.min(count - 1, i4 + this.mCurItem);
            ...
            if (itemInfoAddNewItem != null) {
                ...
                if (f2 < 2.0f) {
                    ...
                    for (int i10 = this.mCurItem + 1; i10 < count; i10++) {
                        if (f2 >= paddingRight && i10 > iMin) {
                            ...
                            if (i10 == itemInfo6.position && !itemInfo6.scrolling) {
                                this.mItems.remove(i9);
                                this.mAdapter.destroyItem((ViewGroup) this, i10, itemInfo6.object);
                                itemInfo6 = i9 < this.mItems.size() ? this.mItems.get(i9) : null;
                            }
                        } else if (itemInfo6 == null || i10 != itemInfo6.position) {
                ...
                calculatePageOffsets(itemInfoAddNewItem, i7, itemInfo);
            }
    ...
    void smoothScrollTo(int i, int i2, int i3) {
        ...
        if (iAbs2 > 0) {
            iAbs = Math.round(1000.0f * Math.abs(((f2 * fDistanceInfluenceForSnapDuration) + f) / iAbs2)) * 4;
        } else {
