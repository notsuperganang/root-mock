...
class NotificationCompatJellybean {
    ...
    public static NotificationCompatBase.Action readAction(NotificationCompatBase.Action.Factory factory, RemoteInputCompatBase.RemoteInput.Factory factory2, int i, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle) {
        ...
        RemoteInputCompatBase.RemoteInput[] remoteInputArrFromBundleArray2;
        boolean z = false;
        if (bundle != null) {
            remoteInputArrFromBundleArray2 = RemoteInputCompatJellybean.fromBundleArray(BundleUtil.getBundleArrayFromBundle(bundle, NotificationCompatExtras.EXTRA_REMOTE_INPUTS), factory2);
            remoteInputArrFromBundleArray = RemoteInputCompatJellybean.fromBundleArray(BundleUtil.getBundleArrayFromBundle(bundle, EXTRA_DATA_ONLY_REMOTE_INPUTS), factory2);
            z = bundle.getBoolean(EXTRA_ALLOW_GENERATED_REPLIES);
        } else {
            remoteInputArrFromBundleArray = null;
            remoteInputArrFromBundleArray2 = null;
        }
        return factory.build(i, charSequence, pendingIntent, bundle, remoteInputArrFromBundleArray2, remoteInputArrFromBundleArray, z);
    }
