...
public class FontsContractCompat {
    ...
    /* JADX INFO: renamed from: android.support.v4.provider.FontsContractCompat$4, reason: invalid class name */
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public static Typeface getFontSync(Context context, FontRequest fontRequest, @Nullable TextView textView, int i, int i2, int i3) {
        ...
        Callable<Typeface> callable = new Callable<Typeface>(context, fontRequest, i3, str) { // from class: android.support.v4.provider.FontsContractCompat.1
            final Context val$context;
            final String val$id;
            final FontRequest val$request;
            final int val$style;
            ...
            public Typeface call() throws Exception {
                Typeface fontInternal = FontsContractCompat.getFontInternal(this.val$context, this.val$request, this.val$style);
                if (fontInternal != null) {
                    FontsContractCompat.sTypefaceCache.put(this.val$id, fontInternal);
                }
                return fontInternal;
            }
        };
        ...
        SelfDestructiveThread.ReplyCallback<Typeface> replyCallback = new SelfDestructiveThread.ReplyCallback<Typeface>(new WeakReference(textView), textView, i3) { // from class: android.support.v4.provider.FontsContractCompat.2
            final int val$style;
            ...
            public void onReply(Typeface typeface2) {
                if (((TextView) this.val$textViewWeak.get()) != null) {
                    this.val$targetView.setTypeface(typeface2, this.val$style);
                }
            }
        };
        synchronized (sLock) {
            if (sPendingReplies.containsKey(str)) {
                ...
                sBackgroundThread.postAndReply(callable, new SelfDestructiveThread.ReplyCallback<Typeface>(str) { // from class: android.support.v4.provider.FontsContractCompat.3
                    final String val$id;
                    ...
                    public void onReply(Typeface typeface2) {
                        ...
                        synchronized (FontsContractCompat.sLock) {
                            arrayList2 = (ArrayList) FontsContractCompat.sPendingReplies.get(this.val$id);
