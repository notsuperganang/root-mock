...
final class SwipeProgressBar {
    ...
    void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            float f = ((jCurrentAnimationTimeMillis - j) % 2000) / 20.0f;
            if (this.mRunning) {
                z = false;
            } else {
                ...
                float interpolation = (iWidth / 2) * INTERPOLATOR.getInterpolation((((jCurrentAnimationTimeMillis - this.mFinishTime) % 1000) / 10.0f) / 100.0f);
