...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    /* JADX INFO: renamed from: android.support.v7.app.AppCompatDelegateImplV9$5, reason: invalid class name */
    class AnonymousClass5 implements Runnable {
        final AppCompatDelegateImplV9 this$0;

        AnonymousClass5(AppCompatDelegateImplV9 appCompatDelegateImplV9) {
        ...
        public void run() {
            ...
            if (!this.this$0.shouldAnimateActionModeView()) {
                ...
                this.this$0.mFadeAnim.setListener(new ViewPropertyAnimatorListenerAdapter(this) { // from class: android.support.v7.app.AppCompatDelegateImplV9.5.1
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            if (this.this$0.mActionModeView != null) {
                ...
                this.this$0.mFadeAnim.setListener(new ViewPropertyAnimatorListenerAdapter(this) { // from class: android.support.v7.app.AppCompatDelegateImplV9.ActionModeCallbackWrapperV9.1
    ...
    AppCompatDelegateImplV9(Context context, Window window, AppCompatCallback appCompatCallback) {
        ...
        this.mFadeAnim = null;
        this.mInvalidatePanelMenuRunnable = new Runnable(this) { // from class: android.support.v7.app.AppCompatDelegateImplV9.1
            final AppCompatDelegateImplV9 this$0;
    ...
    private ViewGroup createSubDecor() {
        ...
        if (this.mWindowNoTitle) {
            ViewGroup viewGroup3 = this.mOverlayActionMode ? (ViewGroup) layoutInflaterFrom.inflate(R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null) : (ViewGroup) layoutInflaterFrom.inflate(R.layout.abc_screen_simple, (ViewGroup) null);
            if (Build.VERSION.SDK_INT >= 21) {
                ViewCompat.setOnApplyWindowInsetsListener(viewGroup3, new OnApplyWindowInsetsListener(this) { // from class: android.support.v7.app.AppCompatDelegateImplV9.2
                    final AppCompatDelegateImplV9 this$0;
                ...
                ((FitWindowsViewGroup) viewGroup3).setOnFitSystemWindowsListener(new FitWindowsViewGroup.OnFitSystemWindowsListener(this) { // from class: android.support.v7.app.AppCompatDelegateImplV9.3
                    final AppCompatDelegateImplV9 this$0;
            ...
            if (this.mIsFloating) {
                viewGroup2 = (ViewGroup) layoutInflaterFrom.inflate(R.layout.abc_dialog_title_material, (ViewGroup) null);
        ...
        contentFrameLayout.setAttachListener(new ContentFrameLayout.OnAttachListener(this) { // from class: android.support.v7.app.AppCompatDelegateImplV9.4
            final AppCompatDelegateImplV9 this$0;
        ...
        if (actionModeOnWindowStartingSupportActionMode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mShowActionModePopup = new AnonymousClass5(this);
                } else {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(standaloneActionMode, standaloneActionMode.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        ...
                        this.mFadeAnim.setListener(new ViewPropertyAnimatorListenerAdapter(this) { // from class: android.support.v7.app.AppCompatDelegateImplV9.6
                            final AppCompatDelegateImplV9 this$0;
