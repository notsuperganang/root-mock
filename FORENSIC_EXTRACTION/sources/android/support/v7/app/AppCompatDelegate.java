...
public abstract class AppCompatDelegate {
    ...
    private static AppCompatDelegate create(Context context, Window window, AppCompatCallback appCompatCallback) {
        ...
        return Build.VERSION.SDK_INT >= 11 ? new AppCompatDelegateImplV11(context, window, appCompatCallback) : new AppCompatDelegateImplV9(context, window, appCompatCallback);
    }
