...
public class MenuBuilder implements SupportMenu {
    ...
    void findItemsWithShortcutForKey(List<MenuItemImpl> list, int i, KeyEvent keyEvent) {
        ...
        if (keyEvent.getKeyData(keyData) || i == 67) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                char alphabeticShortcut = zIsQwertyMode ? menuItemImpl.getAlphabeticShortcut() : menuItemImpl.getNumericShortcut();
                if (((69647 & modifiers) == ((zIsQwertyMode ? menuItemImpl.getAlphabeticModifiers() : menuItemImpl.getNumericModifiers()) & SupportMenu.SUPPORTED_MODIFIERS_MASK)) && alphabeticShortcut != 0 && ((alphabeticShortcut == keyData.meta[0] || alphabeticShortcut == keyData.meta[2] || (zIsQwertyMode && alphabeticShortcut == '\b' && i == 67)) && menuItemImpl.isEnabled())) {
    ...
    /* JADX WARN: Code duplicated, block: B:20:0x0051 A[PHI: r0
      0x0051: PHI (r0v2 android.util.SparseArray<? extends android.os.Parcelable>) = 
      (r0v1 android.util.SparseArray<? extends android.os.Parcelable>)
      (r0v1 android.util.SparseArray<? extends android.os.Parcelable>)
      (r0v7 android.util.SparseArray<? extends android.os.Parcelable>)
     binds: [B:5:0x0011, B:7:0x0018, B:11:0x0028] A[DONT_GENERATE, DONT_INLINE]] */
