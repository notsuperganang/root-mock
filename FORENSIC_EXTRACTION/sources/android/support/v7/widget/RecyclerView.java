...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    public static abstract class LayoutManager {
        ...
        private int[] getChildRectangleOnScreenScrollAmount(RecyclerView recyclerView, View view, Rect rect, boolean z) {
            ...
            if (getLayoutDirection() != 1) {
                iMax = iMin == 0 ? Math.min(left - paddingLeft, iMax) : iMin;
            } else if (iMax == 0) {
                iMax = Math.max(iMin, iWidth - width);
            }
            if (iMin2 == 0) {
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, com.tiket.git.R.styleable.RecyclerView, i, i2);
            properties.orientation = typedArrayObtainStyledAttributes.getInt(com.tiket.git.R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = typedArrayObtainStyledAttributes.getInt(com.tiket.git.R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = typedArrayObtainStyledAttributes.getBoolean(com.tiket.git.R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = typedArrayObtainStyledAttributes.getBoolean(com.tiket.git.R.styleable.RecyclerView_stackFromEnd, false);
        ...
        /* JADX WARN: Code duplicated, block: B:9:0x0014 A[RETURN, SYNTHETIC] */
        ...
        /* JADX WARN: Code duplicated, block: B:22:0x0074 A[PHI: r2
          0x0074: PHI (r2v8 int) = (r2v4 int), (r2v12 int) binds: [B:20:0x0063, B:14:0x0035] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static class RecycledViewPool {
        ...
        int size() {
            ...
            while (i < this.mScrap.size()) {
                ...
                i++;
                size = arrayList != null ? arrayList.size() + size : size;
            }
            return size;
        }
    ...
    public final class Recycler {
        ...
        void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                throw new IllegalArgumentException("Scrapped or attached views may not be recycled. isScrap:" + viewHolder.isScrap() + " isAttached:" + (viewHolder.itemView.getParent() != null) + this.this$0.exceptionLabel());
            }
        ...
        /* JADX WARN: Code duplicated, block: B:102:0x025e  */
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int i, boolean z, long j) {
            ...
            if (recycledView == null) {
                ...
                if (recycledView == null) {
                    ...
                    ViewHolder viewHolderCreateViewHolder = this.this$0.mAdapter.createViewHolder(this.this$0, itemViewType);
            ...
            if (z3 && !this.this$0.mState.isPreLayout() && viewHolder.hasAnyOfTheFlags(8192)) {
                viewHolder.setFlags(0, 8192);
                if (this.this$0.mState.mRunSimpleAnimations) {
                    this.this$0.recordAnimationInfoIfBouncedHiddenView(viewHolder, this.this$0.mItemAnimator.recordPreLayoutInformation(this.this$0.mState, viewHolder, ItemAnimator.buildAdapterChangeFlagsForAnimations(viewHolder) | 4096, viewHolder.getUnmodifiedPayloads()));
                }
            }
            if (!this.this$0.mState.isPreLayout() || !viewHolder.isBound()) {
                if (!viewHolder.isBound() || viewHolder.needsUpdate() || viewHolder.isInvalid()) {
                    zTryBindViewHolderByDeadline = tryBindViewHolderByDeadline(viewHolder, this.this$0.mAdapterHelper.findPositionOffset(i), i, j);
                }
                ...
                if (z3 && zTryBindViewHolderByDeadline) {
                    z5 = true;
                }
    ...
    class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int i, int i2, int i3, int i4) {
            ...
            float f = i5;
            float f2 = i5;
            float fDistanceInfluenceForSnapDuration = distanceInfluenceForSnapDuration(Math.min(1.0f, (iSqrt2 * 1.0f) / width));
            if (iSqrt > 0) {
                iRound = Math.round(1000.0f * Math.abs(((f2 * fDistanceInfluenceForSnapDuration) + f) / iSqrt)) * 4;
            } else {
                iRound = (int) ((((z ? iAbs : iAbs2) / width) + 1.0f) * 300.0f);
            }
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (this.this$0.dispatchNestedPreScroll(i9, i10, iArr, null, 1)) {
                    int i11 = iArr[0];
                    i = i10 - iArr[1];
                    i2 = i9 - i11;
                } else {
                ...
                if (this.this$0.mAdapter != null) {
                    ...
                    this.this$0.fillRemainingScrollValues(this.this$0.mState);
                    if (i2 != 0) {
                        iScrollHorizontallyBy = this.this$0.mLayout.scrollHorizontallyBy(i2, this.this$0.mRecycler, this.this$0.mState);
                    ...
                    if (i != 0) {
                        int iScrollVerticallyBy = this.this$0.mLayout.scrollVerticallyBy(i, this.this$0.mRecycler, this.this$0.mState);
                        i8 = i - iScrollVerticallyBy;
                    ...
                    if (smoothScroller == null || smoothScroller.isPendingInitialRun() || !smoothScroller.isRunning()) {
                        ...
                        if (itemCount == 0) {
                            ...
                            smoothScroller.onAnimation(i2 - i4, i - i8);
                            i6 = i8;
                            i3 = iScrollHorizontallyBy;
                        } else {
                            smoothScroller.onAnimation(i2 - i4, i - i8);
                ...
                if (this.this$0.getOverScrollMode() != 2) {
                    this.this$0.considerReleasingGlowsOnScroll(i2, i);
                }
                if (!this.this$0.dispatchNestedScroll(i3, i5, i4, i6, null, 1) && (i4 != 0 || i6 != 0)) {
                    ...
                    if ((i7 != 0 || i4 == currX || overScroller.getFinalX() == 0) && (currVelocity != 0 || i6 == currY || overScroller.getFinalY() == 0)) {
                ...
                boolean z = (i2 == 0 && i == 0) || (i2 != 0 && this.this$0.mLayout.canScrollHorizontally() && i3 == i2) || (i != 0 && this.this$0.mLayout.canScrollVertically() && i5 == i);
                if (overScroller.isFinished() || !(z || this.this$0.hasNestedScrollingParent(1))) {
                    ...
                    if (this.this$0.mGapWorker != null) {
                        this.this$0.mGapWorker.postFromTraversal(this.this$0, i2, i);
                    }
                }
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, com.tiket.git.R.styleable.RecyclerView, i, 0);
            String string = typedArrayObtainStyledAttributes2.getString(com.tiket.git.R.styleable.RecyclerView_layoutManager);
            if (typedArrayObtainStyledAttributes2.getInt(com.tiket.git.R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = typedArrayObtainStyledAttributes2.getBoolean(com.tiket.git.R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) typedArrayObtainStyledAttributes2.getDrawable(com.tiket.git.R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), typedArrayObtainStyledAttributes2.getDrawable(com.tiket.git.R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) typedArrayObtainStyledAttributes2.getDrawable(com.tiket.git.R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), typedArrayObtainStyledAttributes2.getDrawable(com.tiket.git.R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    public View focusSearch(View view, int i) {
        ...
        if (z3 && (i == 2 || i == 1)) {
            if (this.mLayout.canScrollVertically()) {
                ...
                i2 = FORCE_ABS_FOCUS_SEARCH_DIRECTION ? i3 : i;
            } else {
                z = false;
                i2 = i;
            }
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(com.tiket.git.R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(com.tiket.git.R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(com.tiket.git.R.dimen.fastscroll_margin));
    }
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        scrollByInternal((int) (this.mScaledHorizontalScrollFactor * axisValue), (int) (f * this.mScaledVerticalScrollFactor), motionEvent);
        return false;
    }
    ...
    boolean scrollByInternal(int i, int i2, MotionEvent motionEvent) {
        ...
        if (this.mAdapter != null) {
            ...
            if (i != 0) {
                ...
                i4 = i - iScrollHorizontallyBy;
            } else {
                i4 = 0;
                iScrollHorizontallyBy = 0;
            }
            if (i2 != 0) {
                int iScrollVerticallyBy = this.mLayout.scrollVerticallyBy(i2, this.mRecycler, this.mState);
        ...
        if (dispatchNestedScroll(i6, i5, i4, i3, this.mScrollOffset, 0)) {
            ...
            if (motionEvent != null && !MotionEventCompat.isFromSource(motionEvent, 8194)) {
                pullGlows(motionEvent.getX(), i4, motionEvent.getY(), i3);
            }
