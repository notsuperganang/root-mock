...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, com.tiket.git.R.attr.switchStyle);
    }
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, com.tiket.git.R.styleable.SwitchCompat, i, 0);
        this.mThumbDrawable = tintTypedArrayObtainStyledAttributes.getDrawable(com.tiket.git.R.styleable.SwitchCompat_android_thumb);
        if (this.mThumbDrawable != null) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = tintTypedArrayObtainStyledAttributes.getDrawable(com.tiket.git.R.styleable.SwitchCompat_track);
        if (this.mTrackDrawable != null) {
            this.mTrackDrawable.setCallback(this);
        }
        this.mTextOn = tintTypedArrayObtainStyledAttributes.getText(com.tiket.git.R.styleable.SwitchCompat_android_textOn);
        this.mTextOff = tintTypedArrayObtainStyledAttributes.getText(com.tiket.git.R.styleable.SwitchCompat_android_textOff);
        this.mShowText = tintTypedArrayObtainStyledAttributes.getBoolean(com.tiket.git.R.styleable.SwitchCompat_showText, true);
        this.mThumbTextPadding = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(com.tiket.git.R.styleable.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(com.tiket.git.R.styleable.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(com.tiket.git.R.styleable.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = tintTypedArrayObtainStyledAttributes.getBoolean(com.tiket.git.R.styleable.SwitchCompat_splitTrack, false);
        ColorStateList colorStateList = tintTypedArrayObtainStyledAttributes.getColorStateList(com.tiket.git.R.styleable.SwitchCompat_thumbTint);
        if (colorStateList != null) {
            this.mThumbTintList = colorStateList;
            this.mHasThumbTint = true;
        }
        PorterDuff.Mode tintMode = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(com.tiket.git.R.styleable.SwitchCompat_thumbTintMode, -1), null);
        ...
        ColorStateList colorStateList2 = tintTypedArrayObtainStyledAttributes.getColorStateList(com.tiket.git.R.styleable.SwitchCompat_trackTint);
        if (colorStateList2 != null) {
            this.mTrackTintList = colorStateList2;
            this.mHasTrackTint = true;
        }
        PorterDuff.Mode tintMode2 = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(com.tiket.git.R.styleable.SwitchCompat_trackTintMode, -1), null);
        ...
        int resourceId = tintTypedArrayObtainStyledAttributes.getResourceId(com.tiket.git.R.styleable.SwitchCompat_switchTextAppearance, 0);
        if (resourceId != 0) {
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (ViewUtils.isLayoutRtl(this)) {
            ...
            i5 = iMax + (width - this.mSwitchWidth) + iMax2;
            i6 = width;
        }
        switch (getGravity() & com.tiket.git.R.styleable.AppCompatTheme_seekBarStyle) {
            case 16:
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, i, com.tiket.git.R.styleable.TextAppearance);
        ColorStateList colorStateList = tintTypedArrayObtainStyledAttributes.getColorStateList(com.tiket.git.R.styleable.TextAppearance_android_textColor);
        if (colorStateList != null) {
            this.mTextColors = colorStateList;
        } else {
            this.mTextColors = getTextColors();
        }
        int dimensionPixelSize = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(com.tiket.git.R.styleable.TextAppearance_android_textSize, 0);
        if (dimensionPixelSize != 0 && dimensionPixelSize != this.mTextPaint.getTextSize()) {
            this.mTextPaint.setTextSize(dimensionPixelSize);
            requestLayout();
        }
        setSwitchTypefaceByIndex(tintTypedArrayObtainStyledAttributes.getInt(com.tiket.git.R.styleable.TextAppearance_android_typeface, -1), tintTypedArrayObtainStyledAttributes.getInt(com.tiket.git.R.styleable.TextAppearance_android_textStyle, -1));
        if (tintTypedArrayObtainStyledAttributes.getBoolean(com.tiket.git.R.styleable.TextAppearance_textAllCaps, false)) {
