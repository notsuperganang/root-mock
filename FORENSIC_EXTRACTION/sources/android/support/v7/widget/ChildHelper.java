...
class ChildHelper {
    ...
    static class Bucket {
        ...
        int countOnesBefore(int i) {
            ...
            return i < 64 ? Long.bitCount(this.mData & ((1 << i) - 1)) : this.mNext.countOnesBefore(i - 64) + Long.bitCount(this.mData);
        }
        ...
        boolean remove(int i) {
            ...
            this.mData &= (-1) ^ j;
            long j2 = j - 1;
            this.mData = (j2 & this.mData) | Long.rotateRight((j2 ^ (-1)) & this.mData, 1);
            if (this.mNext == null) {
                return z;
            }
            if (this.mNext.get(0)) {
