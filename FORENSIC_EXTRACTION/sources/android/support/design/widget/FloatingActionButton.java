...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    public static class Behavior extends CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        private boolean shouldUpdateVisibility(View view, FloatingActionButton floatingActionButton) {
            ...
            if (layoutParams.getAnchorId() == view.getId() && floatingActionButton.getUserSetVisibility() == 0) {
    ...
    private FloatingActionButtonImpl createImpl() {
        return Build.VERSION.SDK_INT >= 21 ? new FloatingActionButtonLollipop(this, new ShadowDelegateImpl(this)) : new FloatingActionButtonImpl(this, new ShadowDelegateImpl(this));
    }
