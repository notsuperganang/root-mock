...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(com.tiket.git.R.dimen.design_bottom_navigation_text_size);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(com.tiket.git.R.dimen.design_bottom_navigation_active_text_size);
        this.mDefaultMargin = resources.getDimensionPixelSize(com.tiket.git.R.dimen.design_bottom_navigation_margin);
        ...
        LayoutInflater.from(context).inflate(com.tiket.git.R.layout.design_bottom_navigation_item, (ViewGroup) this, true);
        setBackgroundResource(com.tiket.git.R.drawable.design_bottom_navigation_item_background);
        this.mIcon = (ImageView) findViewById(com.tiket.git.R.id.icon);
        this.mSmallLabel = (TextView) findViewById(com.tiket.git.R.id.smallLabel);
        this.mLargeLabel = (TextView) findViewById(com.tiket.git.R.id.largeLabel);
    }
