...
public class NavigationMenuItemView extends ForegroundLinearLayout implements MenuView.ItemView {
    ...
    public NavigationMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mAccessibilityDelegate = new AccessibilityDelegateCompat(this) { // from class: android.support.design.internal.NavigationMenuItemView.1
        ...
        setOrientation(0);
        LayoutInflater.from(context).inflate(com.tiket.git.R.layout.design_navigation_menu_item, (ViewGroup) this, true);
        this.mIconSize = context.getResources().getDimensionPixelSize(com.tiket.git.R.dimen.design_navigation_icon_size);
        this.mTextView = (CheckedTextView) findViewById(com.tiket.git.R.id.design_menu_item_text);
    ...
    private StateListDrawable createDefaultBackground() {
        ...
        if (!getContext().getTheme().resolveAttribute(com.tiket.git.R.attr.colorControlHighlight, typedValue, true)) {
            return null;
        }
    ...
    private void setActionView(View view) {
        if (view != null) {
            if (this.mActionArea == null) {
                this.mActionArea = (FrameLayout) ((ViewStub) findViewById(com.tiket.git.R.id.design_menu_item_action_area_stub)).inflate();
            }
    ...
    public void setIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            if (this.mEmptyDrawable == null) {
                this.mEmptyDrawable = ResourcesCompat.getDrawable(getResources(), com.tiket.git.R.drawable.navigation_empty_icon, getContext().getTheme());
                if (this.mEmptyDrawable != null) {
