...
public final class zzai {
    ...
    public static final class zza<V> {
        ...
        private static void zzja() {
            synchronized (zza.class) {
                try {
                    ...
                    try {
                        for (zza<Boolean> zzaVar : zzai.zzaik) {
                            ((zza) zzaVar).zzall = (V) ((zza) zzaVar).zzalj.get();
                        }
                        for (zza<String> zzaVar2 : zzai.zzail) {
                            ((zza) zzaVar2).zzall = (V) ((zza) zzaVar2).zzalj.get();
                        }
                        for (zza<Long> zzaVar3 : zzai.zzaij) {
                            ((zza) zzaVar3).zzall = (V) ((zza) zzaVar3).zzalj.get();
                        }
                        for (zza<Integer> zzaVar4 : zzai.zzaii) {
                            ((zza) zzaVar4).zzall = (V) ((zza) zzaVar4).zzalj.get();
                        }
                        for (zza<Double> zzaVar5 : zzai.zzaim) {
                            ((zza) zzaVar5).zzall = (V) ((zza) zzaVar5).zzalj.get();
                        }
        ...
        public static void zzq() {
            synchronized (zza.class) {
                try {
                    for (zza<Boolean> zzaVar : zzai.zzaik) {
                        zzso zzsoVar = zzai.zzain;
                        String str = ((zza) zzaVar).zzoj;
                        zzn zznVar = zzai.zzaih;
                        ((zza) zzaVar).zzalj = (zzsi<V>) zzsoVar.zzd(str, ((zza) zzaVar).zzaan.booleanValue());
                    }
                    for (zza<String> zzaVar2 : zzai.zzail) {
                        zzso zzsoVar2 = zzai.zzain;
                        String str2 = ((zza) zzaVar2).zzoj;
                        zzn zznVar2 = zzai.zzaih;
                        ((zza) zzaVar2).zzalj = (zzsi<V>) zzsoVar2.zzy(str2, ((zza) zzaVar2).zzaan);
                    }
                    for (zza<Long> zzaVar3 : zzai.zzaij) {
                        zzso zzsoVar3 = zzai.zzain;
                        String str3 = ((zza) zzaVar3).zzoj;
                        zzn zznVar3 = zzai.zzaih;
                        ((zza) zzaVar3).zzalj = (zzsi<V>) zzsoVar3.zze(str3, ((zza) zzaVar3).zzaan.longValue());
                    }
                    for (zza<Integer> zzaVar4 : zzai.zzaii) {
                        zzso zzsoVar4 = zzai.zzain;
                        String str4 = ((zza) zzaVar4).zzoj;
                        zzn zznVar4 = zzai.zzaih;
                        ((zza) zzaVar4).zzalj = (zzsi<V>) zzsoVar4.zzd(str4, ((zza) zzaVar4).zzaan.intValue());
                    }
                    for (zza<Double> zzaVar5 : zzai.zzaim) {
                        zzso zzsoVar5 = zzai.zzain;
                        String str5 = ((zza) zzaVar5).zzoj;
                        zzn zznVar5 = zzai.zzaih;
                        ((zza) zzaVar5).zzalj = (zzsi<V>) zzsoVar5.zzb(str5, ((zza) zzaVar5).zzaan.doubleValue());
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    static void zza(zzbw zzbwVar) {
        zzada = zzbwVar;
    }

    static void zza(zzn zznVar) {
        zzaih = zznVar;
        zza.zzq();
    }
