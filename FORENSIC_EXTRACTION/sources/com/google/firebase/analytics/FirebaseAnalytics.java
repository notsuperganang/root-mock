...
public final class FirebaseAnalytics {
    ...
    public final String zzgc() {
        String str;
        synchronized (this.zzbsp) {
            str = Math.abs(this.zzada.zzbx().elapsedRealtime() - this.zzbso) < 1000 ? this.zzbsn : null;
        }
        return str;
    }
    ...
    public final Task<String> getAppInstanceId() {
        try {
            String strZzgc = zzgc();
            return strZzgc != null ? Tasks.forResult(strZzgc) : Tasks.call(this.zzada.zzgs().zzkg(), new zza(this));
        } catch (Exception e) {
