...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (layoutState.hasMore(state) && (this.mLayoutState.mInfinite || !this.mRemainingSpans.isEmpty())) {
            ...
            if (layoutState.mLayoutDirection == 1) {
                int maxEnd2 = layoutParams.mFullSpan ? getMaxEnd(endAfterPadding) : span.getEndLine(endAfterPadding);
                decoratedMeasurement2 = this.mPrimaryOrientation.getDecoratedMeasurement(next) + maxEnd2;
            ...
            if (isLayoutRTL() && this.mOrientation == 1) {
                ...
                startAfterPadding = endAfterPadding2 - this.mSecondaryOrientation.getDecoratedMeasurement(next);
                ...
                decoratedMeasurement3 = startAfterPadding + this.mSecondaryOrientation.getDecoratedMeasurement(next);
            }
            if (this.mOrientation == 1) {
                layoutDecoratedWithMargins(next, startAfterPadding, decoratedMeasurement, decoratedMeasurement3, i2);
            } else {
                layoutDecoratedWithMargins(next, decoratedMeasurement, startAfterPadding, i2, decoratedMeasurement3);
            }
            if (layoutParams.mFullSpan) {
    ...
    /* JADX WARN: Code duplicated, block: B:55:0x0099 A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:59:0x005d A[SYNTHETIC] */
    /* JADX WARN: Code duplicated, block: B:60:0x005d A[SYNTHETIC] */
    View hasGapsToFix() {
        int i;
        boolean z;
        boolean z2;
            ...
            if (z || (focusableViewAfter = span.getFocusableViewAfter(lastChildPosition, iConvertFocusDirectionToLayoutDirection)) == null || focusableViewAfter == viewFindContainingItemView) {
                if (preferLastSpan(iConvertFocusDirectionToLayoutDirection)) {
                    for (int i2 = this.mSpanCount - 1; i2 >= 0; i2--) {
                        focusableViewAfter = this.mSpans[i2].getFocusableViewAfter(lastChildPosition, iConvertFocusDirectionToLayoutDirection);
