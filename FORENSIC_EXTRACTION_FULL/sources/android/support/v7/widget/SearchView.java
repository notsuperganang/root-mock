...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            switch (motionEvent.getAction()) {
                ...
                case 2:
                    ...
                    z2 = !z || this.mSlopBounds.contains(x, y);
                    break;
                case 3:
                    z = this.mDelegateTargeted;
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new View.OnLayoutChangeListener(this) { // from class: android.support.v7.widget.SearchView.4
                final SearchView this$0;
    ...
    public CharSequence getQueryHint() {
        ...
        return (this.mSearchable == null || this.mSearchable.getHintId() == 0) ? this.mDefaultQueryHint : getContext().getText(this.mSearchable.getHintId());
    }
