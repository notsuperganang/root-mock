...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    void animateChangeImpl(ChangeInfo changeInfo) {
        ...
        if (view != null) {
            ...
            duration.alpha(0.0f).setListener(new AnimatorListenerAdapter(this, changeInfo, duration, view) { // from class: android.support.v7.widget.DefaultItemAnimator.7
                final DefaultItemAnimator this$0;
        ...
        if (view2 != null) {
            ...
            viewPropertyAnimatorAnimate.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(1.0f).setListener(new AnimatorListenerAdapter(this, changeInfo, viewPropertyAnimatorAnimate, view2) { // from class: android.support.v7.widget.DefaultItemAnimator.8
                final DefaultItemAnimator this$0;
                final ChangeInfo val$changeInfo;
