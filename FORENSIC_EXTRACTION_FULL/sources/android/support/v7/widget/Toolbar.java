...
public class Toolbar extends ViewGroup {
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            ...
            if (this.this$0.mExpandedActionView.getParent() != this.this$0) {
                ...
                layoutParamsGenerateDefaultLayoutParams.gravity = 8388611 | (this.this$0.mButtonGravity & R.styleable.AppCompatTheme_seekBarStyle);
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            layoutParamsGenerateDefaultLayoutParams.gravity = 8388613 | (this.mButtonGravity & R.styleable.AppCompatTheme_seekBarStyle);
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            ...
            LayoutParams layoutParamsGenerateDefaultLayoutParams = generateDefaultLayoutParams();
            layoutParamsGenerateDefaultLayoutParams.gravity = 8388611 | (this.mButtonGravity & R.styleable.AppCompatTheme_seekBarStyle);
    ...
    private int getChildVerticalGravity(int i) {
        ...
        switch (i2) {
            ...
            case Place.TYPE_ROOFING_CONTRACTOR /* 80 */:
                return i2;
            default:
                return this.mGravity & R.styleable.AppCompatTheme_seekBarStyle;
        }
    }
    ...
    private int getViewListMeasuredWidth(List<View> list, int[] iArr) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            iMax2 = Math.max(0, -i4);
            iMax = Math.max(0, -i5);
            measuredWidth = view.getMeasuredWidth() + iMax3 + iMax4 + measuredWidth;
        }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (!shouldLayout(this.mNavButtonView)) {
            ...
            iLayoutChildRight = layoutChildRight(this.mNavButtonView, i10, iArr, iMin);
            iLayoutChildLeft = paddingLeft;
        } else {
        ...
        int iMax4 = Math.max(iLayoutChildLeft, currentContentInsetLeft);
        int iMin2 = Math.min(iLayoutChildRight, (width - paddingRight) - currentContentInsetRight);
        if (shouldLayout(this.mExpandedActionView)) {
            if (z2) {
                iMin2 = layoutChildRight(this.mExpandedActionView, iMin2, iArr, iMin);
            } else {
                iMax4 = layoutChildLeft(this.mExpandedActionView, iMax4, iArr, iMin);
            }
        }
        if (!shouldLayout(this.mLogoView)) {
            ...
            iMax = iMax4;
            iMax2 = layoutChildRight(this.mLogoView, iMin2, iArr, iMin);
        } else {
            iMax = layoutChildLeft(this.mLogoView, iMax4, iArr, iMin);
            iMax2 = iMin2;
        }
        ...
        if (zShouldLayout || zShouldLayout2) {
            ...
            switch (this.mGravity & R.styleable.AppCompatTheme_seekBarStyle) {
                case 48:
                    paddingTop = this.mTitleMarginTop + layoutParams3.topMargin + getPaddingTop();
                    break;
                case Place.TYPE_ROOFING_CONTRACTOR /* 80 */:
                ...
                default:
                    ...
                    if (i11 < layoutParams3.topMargin + this.mTitleMarginTop) {
                        iMax3 = layoutParams3.topMargin + this.mTitleMarginTop;
                    } else {
                        int i12 = (((height - paddingBottom) - measuredHeight) - i11) - paddingTop2;
                        iMax3 = i12 < layoutParams3.bottomMargin + this.mTitleMarginBottom ? Math.max(0, i11 - ((layoutParams4.bottomMargin + this.mTitleMarginBottom) - i12)) : i11;
                    }
            ...
            if (z2) {
                ...
                iMax2 -= Math.max(0, i13);
                iArr[1] = Math.max(0, -i13);
                if (zShouldLayout) {
                    LayoutParams layoutParams5 = (LayoutParams) this.mTitleTextView.getLayoutParams();
                    int measuredWidth = iMax2 - this.mTitleTextView.getMeasuredWidth();
                    int measuredHeight3 = this.mTitleTextView.getMeasuredHeight() + paddingTop;
                    this.mTitleTextView.layout(measuredWidth, paddingTop, iMax2, measuredHeight3);
                ...
                if (zShouldLayout2) {
                    ...
                    this.mSubtitleTextView.layout(iMax2 - this.mSubtitleTextView.getMeasuredWidth(), i14, iMax2, this.mSubtitleTextView.getMeasuredHeight() + i14);
                    int i15 = this.mTitleMarginEnd;
                    int i16 = layoutParams6.bottomMargin;
                    i9 = iMax2 - i15;
                } else {
                    i9 = iMax2;
                }
                if (z3) {
                    iMax2 = Math.min(i8, i9);
                }
            } else {
                int i17 = (z3 ? this.mTitleMarginStart : 0) - iArr[0];
                iMax += Math.max(0, i17);
                ...
                if (zShouldLayout) {
                    ...
                    i5 = measuredWidth2 + this.mTitleMarginEnd;
                    i6 = layoutParams7.bottomMargin + measuredHeight4;
                } else {
                    i5 = iMax;
                    i6 = paddingTop;
                }
                if (zShouldLayout2) {
                    ...
                    int i18 = i6 + layoutParams8.topMargin;
                    int measuredWidth3 = this.mSubtitleTextView.getMeasuredWidth() + iMax;
                    this.mSubtitleTextView.layout(iMax, i18, measuredWidth3, this.mSubtitleTextView.getMeasuredHeight() + i18);
                    int i19 = this.mTitleMarginEnd;
                    int i20 = layoutParams8.bottomMargin;
                    i7 = i19 + measuredWidth3;
                } else {
                    i7 = iMax;
                }
                if (z3) {
        ...
        for (int i21 = 0; i21 < size; i21++) {
            iLayoutChildLeft2 = layoutChildLeft(this.mTempViews.get(i21), iLayoutChildLeft2, iArr, iMin);
        }
        addCustomViewsWithGravity(this.mTempViews, 5);
        int size2 = this.mTempViews.size();
        for (int i22 = 0; i22 < size2; i22++) {
            iMax2 = layoutChildRight(this.mTempViews.get(i22), iMax2, iArr, iMin);
        }
        addCustomViewsWithGravity(this.mTempViews, 1);
        int viewListMeasuredWidth = getViewListMeasuredWidth(this.mTempViews, iArr);
        int i23 = ((((width - paddingLeft) - paddingRight) / 2) + paddingLeft) - (viewListMeasuredWidth / 2);
        int i24 = viewListMeasuredWidth + i23;
        if (i23 < iLayoutChildLeft2) {
            i23 = iLayoutChildLeft2;
        } else if (i24 > iMax2) {
            i23 -= i24 - iMax2;
        }
        ...
        int i26 = i23;
        while (i25 < size3) {
            int iLayoutChildLeft3 = layoutChildLeft(this.mTempViews.get(i25), i26, iArr, iMin);
            i25++;
            i26 = iLayoutChildLeft3;
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            iMax6 = Math.max(iMax6, measureChildCollapseMargins(this.mSubtitleTextView, i, iMax4 + i6, i2, i5 + measuredHeight, iArr));
        ...
        int iMax7 = Math.max(iMax, measuredHeight);
        int paddingLeft = getPaddingLeft();
        int paddingRight = getPaddingRight();
        int paddingTop = getPaddingTop();
        int paddingBottom = getPaddingBottom();
