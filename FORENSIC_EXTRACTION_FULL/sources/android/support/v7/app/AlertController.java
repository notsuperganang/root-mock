...
class AlertController {
    ...
    public static class AlertParams {
        ...
        private void createListView(AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                checkedItemAdapter = this.mCursor == null ? new ArrayAdapter<CharSequence>(this, this.mContext, alertController.mMultiChoiceItemLayout, i, this.mItems, recycleListView) { // from class: android.support.v7.app.AlertController.AlertParams.1
                ...
                } : new CursorAdapter(this, this.mContext, this.mCursor, z, recycleListView, alertController) { // from class: android.support.v7.app.AlertController.AlertParams.2
                ...
                if (this.mCursor != null) {
                    ...
                    checkedItemAdapter = this.mAdapter != null ? this.mAdapter : new CheckedItemAdapter(this.mContext, i2, R.id.text1, this.mItems);
                }
            }
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, com.tiket.git.R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = typedArrayObtainStyledAttributes.getDimensionPixelOffset(com.tiket.git.R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = typedArrayObtainStyledAttributes.getDimensionPixelOffset(com.tiket.git.R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, com.tiket.git.R.styleable.AlertDialog, com.tiket.git.R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = typedArrayObtainStyledAttributes.getResourceId(com.tiket.git.R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = typedArrayObtainStyledAttributes.getResourceId(com.tiket.git.R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = typedArrayObtainStyledAttributes.getResourceId(com.tiket.git.R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = typedArrayObtainStyledAttributes.getResourceId(com.tiket.git.R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = typedArrayObtainStyledAttributes.getResourceId(com.tiket.git.R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = typedArrayObtainStyledAttributes.getResourceId(com.tiket.git.R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = typedArrayObtainStyledAttributes.getBoolean(com.tiket.git.R.styleable.AlertDialog_showTitle, true);
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        View view2 = null;
        View viewFindViewById = this.mWindow.findViewById(com.tiket.git.R.id.scrollIndicatorUp);
        View viewFindViewById2 = this.mWindow.findViewById(com.tiket.git.R.id.scrollIndicatorDown);
        ...
        if (this.mMessage != null) {
            this.mScrollView.setOnScrollChangeListener(new NestedScrollView.OnScrollChangeListener(this, viewFindViewById, view2) { // from class: android.support.v7.app.AlertController.2
                final AlertController this$0;
            ...
            this.mScrollView.post(new Runnable(this, viewFindViewById, view2) { // from class: android.support.v7.app.AlertController.3
                final AlertController this$0;
                final View val$bottom;
                final View val$top;
            ...
            if (this.mListView != null) {
                this.mListView.setOnScrollListener(new AbsListView.OnScrollListener(this, viewFindViewById, view2) { // from class: android.support.v7.app.AlertController.4
                    final AlertController this$0;
                    final View val$bottom;
                    final View val$top;
                ...
                this.mListView.post(new Runnable(this, viewFindViewById, view2) { // from class: android.support.v7.app.AlertController.5
                    final AlertController this$0;
                    final View val$bottom;
                    final View val$top;
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(com.tiket.git.R.id.scrollView);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(com.tiket.git.R.id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(com.tiket.git.R.id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(com.tiket.git.R.id.alertTitle);
    ...
    private void setupView() {
        ...
        View viewFindViewById3 = this.mWindow.findViewById(com.tiket.git.R.id.parentPanel);
        View viewFindViewById4 = viewFindViewById3.findViewById(com.tiket.git.R.id.topPanel);
        View viewFindViewById5 = viewFindViewById3.findViewById(com.tiket.git.R.id.contentPanel);
        View viewFindViewById6 = viewFindViewById3.findViewById(com.tiket.git.R.id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) viewFindViewById3.findViewById(com.tiket.git.R.id.customPanel);
        setupCustomContent(viewGroup);
        View viewFindViewById7 = viewGroup.findViewById(com.tiket.git.R.id.topPanel);
        View viewFindViewById8 = viewGroup.findViewById(com.tiket.git.R.id.contentPanel);
        View viewFindViewById9 = viewGroup.findViewById(com.tiket.git.R.id.buttonPanel);
        ...
        if (!z3 && viewGroupResolvePanel2 != null && (viewFindViewById2 = viewGroupResolvePanel2.findViewById(com.tiket.git.R.id.textSpacerNoButtons)) != null) {
        ...
        if (z2) {
            ...
            View viewFindViewById10 = (this.mMessage == null && this.mListView == null) ? null : viewGroupResolvePanel.findViewById(com.tiket.git.R.id.titleDividerNoCustom);
            if (viewFindViewById10 != null) {
                viewFindViewById10.setVisibility(0);
            }
        } else if (viewGroupResolvePanel2 != null && (viewFindViewById = viewGroupResolvePanel2.findViewById(com.tiket.git.R.id.textSpacerNoTitle)) != null) {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(com.tiket.git.R.attr.alertDialogCenterButtons, typedValue, true);
