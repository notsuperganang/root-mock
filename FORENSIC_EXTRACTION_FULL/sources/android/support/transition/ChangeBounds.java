...
public class ChangeBounds extends Transition {
    ...
    private boolean parentMatches(View view, View view2) {
        ...
        return view2 == matchedTransitionValues.view;
    }
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        if (parentMatches(viewGroup2, viewGroup3)) {
            ...
            if (i13 > 0) {
                if (this.mResizeClip) {
                    ...
                    if (rect5.equals(rect6)) {
                        ...
                        objectAnimatorOfObject.addListener(new AnimatorListenerAdapter(this, view, rect4, i2, i4, i6, i8) { // from class: android.support.transition.ChangeBounds.8
                    ...
                    if (i13 != 2) {
                        ...
                        animatorSet.addListener(new AnimatorListenerAdapter(this, viewBounds) { // from class: android.support.transition.ChangeBounds.7
                ...
                addListener(new TransitionListenerAdapter(this, viewGroup4) { // from class: android.support.transition.ChangeBounds.9
            ...
            if (iIntValue != iIntValue3 || iIntValue2 != iIntValue4) {
                ...
                objectAnimatorOfPropertyValuesHolder.addListener(new AnimatorListenerAdapter(this, viewGroup, bitmapDrawable, view, transitionAlpha) { // from class: android.support.transition.ChangeBounds.10
                    final ChangeBounds this$0;
