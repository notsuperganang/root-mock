...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    private static int resolveGravity(int i) {
        ...
        return (i2 & R.styleable.AppCompatTheme_seekBarStyle) == 0 ? i2 | 48 : i2;
    }
    ...
    public boolean doViewsOverlap(View view, View view2) {
        ...
        try {
            return rectAcquireTempRect.left <= rectAcquireTempRect2.right && rectAcquireTempRect.top <= rectAcquireTempRect2.bottom && rectAcquireTempRect.right >= rectAcquireTempRect2.left && rectAcquireTempRect.bottom >= rectAcquireTempRect2.top;
        } finally {
            releaseTempRect(rectAcquireTempRect);
            releaseTempRect(rectAcquireTempRect2);
        }
            ...
            if (view.getVisibility() == 8) {
                ...
                if (layoutParams.keyline >= 0 && mode != 0) {
                    ...
                    if ((absoluteGravity == 3 && !z) || (absoluteGravity == 5 && z)) {
                        iMax3 = Math.max(0, (size - paddingRight) - keyline);
                    } else if ((absoluteGravity == 5 && !z) || (absoluteGravity == 3 && z)) {
                        iMax3 = Math.max(0, keyline - paddingLeft);
                    }
                }
                ...
                Behavior behavior = layoutParams.getBehavior();
                if (behavior == null || !behavior.onMeasureChild(this, view, iMakeMeasureSpec, iMax3, iMakeMeasureSpec2, 0)) {
                    onMeasureChild(view, iMakeMeasureSpec, iMax3, iMakeMeasureSpec2, 0);
                }
                ...
                iMax2 = Math.max(suggestedMinimumHeight, view.getMeasuredHeight() + paddingTop + paddingBottom + layoutParams.topMargin + layoutParams.bottomMargin);
                iCombineMeasuredStates = View.combineMeasuredStates(i3, view.getMeasuredState());
            }
            i4++;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        Behavior behavior = ((LayoutParams) this.mBehaviorTouchView.getLayoutParams()).getBehavior();
        if (behavior != null) {
            boolean zOnTouchEvent2 = behavior.onTouchEvent(this, this.mBehaviorTouchView, motionEvent);
            zPerformIntercept = z;
