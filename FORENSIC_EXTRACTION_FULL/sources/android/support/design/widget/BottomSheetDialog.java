...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int i) {
        ...
        this.mBottomSheetCallback = new BottomSheetBehavior.BottomSheetCallback(this) { // from class: android.support.design.widget.BottomSheetDialog.4
    ...
    private View wrapInBottomSheet(int i, View view, ViewGroup.LayoutParams layoutParams) {
        ...
        coordinatorLayout.findViewById(R.id.touch_outside).setOnClickListener(new View.OnClickListener(this) { // from class: android.support.design.widget.BottomSheetDialog.1
            final BottomSheetDialog this$0;
        ...
        ViewCompat.setAccessibilityDelegate(frameLayout2, new AccessibilityDelegateCompat(this) { // from class: android.support.design.widget.BottomSheetDialog.2
            ...
            public boolean performAccessibilityAction(View view2, int i2, Bundle bundle) {
                if (i2 != 1048576 || !this.this$0.mCancelable) {
