...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    final SnackbarManager.Callback mManagerCallback = new SnackbarManager.Callback(this) { // from class: android.support.design.widget.BaseTransientBottomBar.3
    ...
    /* JADX INFO: renamed from: android.support.design.widget.BaseTransientBottomBar$5, reason: invalid class name */
    class AnonymousClass5 implements OnAttachStateChangeListener {
        final BaseTransientBottomBar this$0;

        AnonymousClass5(BaseTransientBottomBar baseTransientBottomBar) {
        ...
        public void onViewDetachedFromWindow(View view) {
            if (this.this$0.isShownOrQueued()) {
                BaseTransientBottomBar.sHandler.post(new Runnable(this) { // from class: android.support.design.widget.BaseTransientBottomBar.5.1
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup viewGroup, @NonNull View view, @NonNull ContentViewCallback contentViewCallback) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this.mView, new OnApplyWindowInsetsListener(this) { // from class: android.support.design.widget.BaseTransientBottomBar.2
            final BaseTransientBottomBar this$0;
    ...
    private void animateViewOut(int i) {
        if (Build.VERSION.SDK_INT < 12) {
            ...
            animationLoadAnimation.setAnimationListener(new Animation.AnimationListener(this, i) { // from class: android.support.design.widget.BaseTransientBottomBar.12
                final BaseTransientBottomBar this$0;
                final int val$event;
        ...
        valueAnimator.addListener(new AnimatorListenerAdapter(this, i) { // from class: android.support.design.widget.BaseTransientBottomBar.10
            ...
            public void onAnimationStart(Animator animator) {
                this.this$0.mContentViewCallback.animateContentOut(0, BaseTransientBottomBar.ANIMATION_FADE_DURATION);
            }
        });
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: android.support.design.widget.BaseTransientBottomBar.11
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator2) {
                ...
                if (BaseTransientBottomBar.USE_OFFSET_API) {
                    ViewCompat.offsetTopAndBottom(this.this$0.mView, iIntValue - this.mPreviousAnimatedIntValue);
                } else {
                    this.this$0.mView.setTranslationY(iIntValue);
                }
    ...
    void animateViewIn() {
        if (Build.VERSION.SDK_INT < 12) {
            ...
            animationLoadAnimation.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
            animationLoadAnimation.setDuration(250L);
            animationLoadAnimation.setAnimationListener(new Animation.AnimationListener(this) { // from class: android.support.design.widget.BaseTransientBottomBar.9
                final BaseTransientBottomBar this$0;
        ...
        valueAnimator.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        valueAnimator.setDuration(250L);
        valueAnimator.addListener(new AnimatorListenerAdapter(this) { // from class: android.support.design.widget.BaseTransientBottomBar.7
            final BaseTransientBottomBar this$0;
            ...
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationStart(Animator animator) {
                this.this$0.mContentViewCallback.animateContentIn(70, BaseTransientBottomBar.ANIMATION_FADE_DURATION);
            }
        });
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this, height) { // from class: android.support.design.widget.BaseTransientBottomBar.8
    ...
    final void showView() {
        if (this.mView.getParent() == null) {
            ...
            if (layoutParams instanceof CoordinatorLayout.LayoutParams) {
                ...
                behavior.setListener(new SwipeDismissBehavior.OnDismissListener(this) { // from class: android.support.design.widget.BaseTransientBottomBar.4
                    final BaseTransientBottomBar this$0;
        ...
        this.mView.setOnAttachStateChangeListener(new AnonymousClass5(this));
        if (!ViewCompat.isLaidOut(this.mView)) {
            this.mView.setOnLayoutChangeListener(new OnLayoutChangeListener(this) { // from class: android.support.design.widget.BaseTransientBottomBar.6
                final BaseTransientBottomBar this$0;
