...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    private void animateScrim(int i) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this) { // from class: android.support.design.widget.CollapsingToolbarLayout.2
                final CollapsingToolbarLayout this$0;
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mCollapsingTitleEnabled && this.mDummyView != null) {
            ...
            if (this.mDrawCollapsingTitle) {
                ...
                collapsingTextHelper.setCollapsedBounds((z2 ? this.mToolbar.getTitleMarginEnd() : this.mToolbar.getTitleMarginStart()) + i6, this.mTmpRect.top + maxOffsetForPinChild + this.mToolbar.getTitleMarginTop(), (z2 ? this.mToolbar.getTitleMarginStart() : this.mToolbar.getTitleMarginEnd()) + this.mTmpRect.right, (maxOffsetForPinChild + this.mTmpRect.bottom) - this.mToolbar.getTitleMarginBottom());
