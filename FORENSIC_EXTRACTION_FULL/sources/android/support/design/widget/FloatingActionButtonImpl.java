...
class FloatingActionButtonImpl {
    ...
    private void ensurePreDrawListener() {
        if (this.mPreDrawListener == null) {
            this.mPreDrawListener = new ViewTreeObserver.OnPreDrawListener(this) { // from class: android.support.design.widget.FloatingActionButtonImpl.3
                final FloatingActionButtonImpl this$0;
    ...
    CircularBorderDrawable createBorderDrawable(int i, ColorStateList colorStateList) {
        ...
        circularBorderDrawableNewCircularDrawable.setGradientColors(ContextCompat.getColor(context, com.tiket.git.R.color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, com.tiket.git.R.color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, com.tiket.git.R.color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, com.tiket.git.R.color.design_fab_stroke_end_outer_color));
    ...
    void hide(@Nullable InternalVisibilityChangedListener internalVisibilityChangedListener, boolean z) {
        ...
        if (shouldAnimateVisibilityChange()) {
            this.mAnimState = 1;
            this.mView.animate().scaleX(0.0f).scaleY(0.0f).alpha(0.0f).setDuration(200L).setInterpolator(AnimationUtils.FAST_OUT_LINEAR_IN_INTERPOLATOR).setListener(new AnimatorListenerAdapter(this, z, internalVisibilityChangedListener) { // from class: android.support.design.widget.FloatingActionButtonImpl.1
    ...
    void show(@Nullable InternalVisibilityChangedListener internalVisibilityChangedListener, boolean z) {
        ...
        if (shouldAnimateVisibilityChange()) {
            ...
            this.mView.animate().scaleX(1.0f).scaleY(1.0f).alpha(1.0f).setDuration(200L).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new AnimatorListenerAdapter(this, z, internalVisibilityChangedListener) { // from class: android.support.design.widget.FloatingActionButtonImpl.2
                final FloatingActionButtonImpl this$0;
                final boolean val$fromUser;
                final InternalVisibilityChangedListener val$listener;
