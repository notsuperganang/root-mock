...
public class AppBarLayout extends LinearLayout {
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        private void animateOffsetWithDuration(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, int i, int i2) {
            ...
            if (this.mOffsetAnimator == null) {
                ...
                this.mOffsetAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(this, coordinatorLayout, appBarLayout) { // from class: android.support.design.widget.AppBarLayout.Behavior.1
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout) {
            ...
            if (childIndexOnOffset >= 0) {
                ...
                if ((scrollFlags & 17) == 17) {
                    ...
                    animateOffsetTo(coordinatorLayout, appBarLayout, MathUtils.clamp(minimumHeight, -appBarLayout.getTotalScrollRange(), 0), 0.0f);
                }
            }
        }
            ...
            if (appBarChildOnOffset != null) {
                ...
                if ((scrollFlags & 1) != 0) {
                    ...
                    if (i2 <= 0 || (scrollFlags & 12) == 0) {
                        z2 = (scrollFlags & 2) != 0 && (-i) >= (appBarChildOnOffset.getBottom() - minimumHeight) - appBarLayout.getTopInset();
                    } else {
        ...
        public boolean canDragView(AppBarLayout appBarLayout) {
            ...
            return this.mLastNestedScrollingChildRef == null || !((view = this.mLastNestedScrollingChildRef.get()) == null || !view.isShown() || view.canScrollVertically(-1));
        }
        ...
        public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, int i) {
            ...
            if (this.mOffsetToChildIndexOnLayout >= 0 && (pendingAction & 8) == 0) {
                ...
                setHeaderTopBottomOffset(coordinatorLayout, appBarLayout, this.mOffsetToChildIndexOnLayoutIsMinHeight ? ViewCompat.getMinimumHeight(childAt) + appBarLayout.getTopInset() + i2 : Math.round(childAt.getHeight() * this.mOffsetToChildIndexOnLayoutPerc) + i2);
        ...
        public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, int i, int i2, int i3) {
            ...
            return topBottomOffsetForScrollingSibling - iClamp;
        }
    ...
    private void setExpanded(boolean z, boolean z2, boolean z3) {
        int i = z ? 1 : 2;
        this.mPendingAction = (z3 ? 8 : 0) | (z2 ? 4 : 0) | i;
        requestLayout();
    }
        ...
        while (childCount >= 0) {
            ...
            if ((i2 & 5) == 5) {
                ...
                if ((i2 & 8) != 0) {
                    ...
                    minimumHeight = (i2 & 2) != 0 ? i3 + (measuredHeight - ViewCompat.getMinimumHeight(childAt)) : i3 + (measuredHeight - getTopInset());
                }
            } else {
                if (i > 0) {
                    break;
    ...
    int getDownNestedScrollRange() {
        ...
        minimumHeight = i;
        int iMax2 = Math.max(0, minimumHeight);
        this.mDownScrollRange = iMax2;
        return iMax2;
    }
    ...
    public final int getTotalScrollRange() {
        ...
        minimumHeight = i;
        int iMax2 = Math.max(0, minimumHeight - getTopInset());
        this.mTotalScrollRange = iMax2;
        return iMax2;
    }
