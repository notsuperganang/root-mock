...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    final View.OnClickListener mOnClickListener = new View.OnClickListener(this) { // from class: android.support.design.internal.NavigationMenuPresenter.1
        ...
        public void onClick(View view) {
            ...
            boolean zPerformItemAction = this.this$0.mMenu.performItemAction(itemData, this.this$0, 0);
    ...
    private class NavigationMenuAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        private void prepareMenuItems() {
            ...
            int i3 = 0;
            boolean z2 = false;
            int size2 = this.this$0.mMenu.getVisibleItems().size();
            int i4 = 0;
            while (i4 < size2) {
                MenuItemImpl menuItemImpl = this.this$0.mMenu.getVisibleItems().get(i4);
        ...
        public void onBindViewHolder(ViewHolder viewHolder, int i) {
            switch (getItemViewType(i)) {
                case 0:
                    ...
                    ViewCompat.setBackground(navigationMenuItemView, this.this$0.mItemBackground != null ? this.this$0.mItemBackground.getConstantState().newDrawable() : null);
        ...
        public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            switch (i) {
                case 0:
                    return new NormalViewHolder(this.this$0.mLayoutInflater, viewGroup, this.this$0.mOnClickListener);
                case 1:
                    return new SubheaderViewHolder(this.this$0.mLayoutInflater, viewGroup);
                case 2:
                    return new SeparatorViewHolder(this.this$0.mLayoutInflater, viewGroup);
                case 3:
