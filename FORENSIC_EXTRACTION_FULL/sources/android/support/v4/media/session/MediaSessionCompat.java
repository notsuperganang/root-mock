...
public class MediaSessionCompat {
        ...
        private class StubApi21 implements MediaSessionCompatApi21.Callback {
            ...
            public void onCommand(String str, Bundle bundle, ResultReceiver resultReceiver) {
                try {
                    ...
                    MediaSessionImplApi21 mediaSessionImplApi22 = (MediaSessionImplApi21) this.this$0.mSessionImpl.get();
                    if (mediaSessionImplApi22 == null || mediaSessionImplApi22.mQueue == null) {
                        return;
                    }
                    int i = bundle.getInt("android.support.v4.media.session.command.ARGUMENT_INDEX", -1);
                    QueueItem queueItem = (i < 0 || i >= mediaSessionImplApi22.mQueue.size()) ? null : (QueueItem) mediaSessionImplApi22.mQueue.get(i);
                    if (queueItem != null) {
            ...
            public void onCustomAction(String str, Bundle bundle) {
                ...
                if (str.equals(MediaSessionCompat.ACTION_SET_SHUFFLE_MODE_ENABLED)) {
                    this.this$0.onSetShuffleModeEnabled(bundle.getBoolean(MediaSessionCompat.ACTION_ARGUMENT_SHUFFLE_MODE_ENABLED));
                    return;
                }
        ...
        RemoteControlClient.MetadataEditor buildRccMetadata(Bundle bundle) {
            ...
            if (bundle != null) {
                ...
                if (bundle.containsKey(MediaMetadataCompat.METADATA_KEY_RATING)) {
                    metadataEditorBuildRccMetadata.putObject(R.styleable.AppCompatTheme_buttonBarNeutralButtonStyle, (Object) bundle.getParcelable(MediaMetadataCompat.METADATA_KEY_RATING));
                }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private VolumeProviderCompat.Callback mVolumeCallback = new VolumeProviderCompat.Callback(this) { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
        ...
        class MediaSessionStub extends IMediaSession.Stub {
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void addQueueItemAt(MediaDescriptionCompat mediaDescriptionCompat, int i) {
                this.this$0.postToHandler(26, mediaDescriptionCompat, i);
            }
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void playFromMediaId(String str, Bundle bundle) throws RemoteException {
                this.this$0.postToHandler(8, str, bundle);
            }

            @Override // android.support.v4.media.session.IMediaSession
            public void playFromSearch(String str, Bundle bundle) throws RemoteException {
                this.this$0.postToHandler(9, str, bundle);
            }
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void rateWithExtras(RatingCompat ratingCompat, Bundle bundle) throws RemoteException {
                this.this$0.postToHandler(31, ratingCompat, bundle);
            }

            @Override // android.support.v4.media.session.IMediaSession
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (!this.this$0.mDestroyed) {
                    this.this$0.mControllerCallbacks.register(iMediaControllerCallback);
                } else {
                    try {
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void removeQueueItemAt(int i) {
                this.this$0.postToHandler(28, i);
            }
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void sendCustomAction(String str, Bundle bundle) throws RemoteException {
                this.this$0.postToHandler(20, str, bundle);
            }
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void setRepeatMode(int i) throws RemoteException {
                this.this$0.postToHandler(23, i);
            }
            ...
            @Override // android.support.v4.media.session.IMediaSession
            public void skipToQueueItem(long j) {
                this.this$0.postToHandler(11, Long.valueOf(j));
            }
