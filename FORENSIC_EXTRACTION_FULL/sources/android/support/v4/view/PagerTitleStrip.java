...
public class PagerTitleStrip extends ViewGroup {
    ...
    void updateTextPositions(int i, float f, boolean z) {
        ...
        int i7 = ((width - i6) - ((int) (f2 * ((width - (i5 + paddingLeft)) - i6)))) - (measuredWidth2 / 2);
        int i8 = i7 + measuredWidth2;
        int baseline = this.mPrevText.getBaseline();
        int baseline2 = this.mCurrText.getBaseline();
        int baseline3 = this.mNextText.getBaseline();
        int iMax = Math.max(Math.max(baseline, baseline2), baseline3);
        int i9 = iMax - baseline;
        int i10 = iMax - baseline2;
        int i11 = iMax - baseline3;
        int iMax2 = Math.max(Math.max(this.mPrevText.getMeasuredHeight() + i9, this.mCurrText.getMeasuredHeight() + i10), i11 + this.mNextText.getMeasuredHeight());
        switch (this.mGravity & com.tiket.git.R.styleable.AppCompatTheme_seekBarStyle) {
            case 16:
                int i12 = (((height - paddingTop) - paddingBottom) - iMax2) / 2;
                i2 = i9 + i12;
                i3 = i10 + i12;
                i4 = i11 + i12;
                break;
            case Place.TYPE_ROOFING_CONTRACTOR /* 80 */:
                int i13 = (height - paddingBottom) - iMax2;
                i2 = i9 + i13;
                i3 = i10 + i13;
                i4 = i11 + i13;
                break;
        ...
        int iMin = Math.min(paddingLeft, (i7 - this.mScaledTextSpacing) - measuredWidth);
        this.mPrevText.layout(iMin, i2, measuredWidth + iMin, this.mPrevText.getMeasuredHeight() + i2);
        int iMax3 = Math.max((width - paddingRight) - measuredWidth3, this.mScaledTextSpacing + i8);
