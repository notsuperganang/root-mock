...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    private void finishSpinner(float f) {
        ...
        animateOffsetToStartPosition(this.mCurrentTargetOffsetTop, this.mScale ? null : new Animation.AnimationListener(this) { // from class: android.support.v4.widget.SwipeRefreshLayout.5
            final SwipeRefreshLayout this$0;
    ...
    private void moveSpinner(float f) {
        ...
        float fMax2 = Math.max(0.0f, Math.min(fAbs - f2, 2.0f * f3) / f3);
        float fPow = ((float) (((double) (fMax2 / 4.0f)) - Math.pow(fMax2 / 4.0f, 2.0d))) * 2.0f;
        int i = this.mOriginalOffsetTop;
        int i2 = (int) ((f3 * fMin) + (f3 * fPow * 2.0f));
