...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    /* JADX WARN: Switch 'out' block B:38:0x005f for B:136:0x0334 already processed. Defaulting to fallback option. */
                    ...
                    if (i < 2) {
                        ...
                        if (fragment.mView != null && fragment.mContainer != null) {
                            ...
                            if (animationOrAnimatorLoadAnimation != null) {
                                animateRemoveFragment(fragment, animationOrAnimatorLoadAnimation, i);
                            }
    ...
    private void animateRemoveFragment(@NonNull Fragment fragment, @NonNull AnimationOrAnimator animationOrAnimator, int i) {
        ...
        if (animationOrAnimator.animation != null) {
            ...
            animation.setAnimationListener(new AnimationListenerWrapper(this, getAnimationListener(animation), fragment) { // from class: android.support.v4.app.FragmentManagerImpl.2
                final FragmentManagerImpl this$0;
    ...
    void moveToState(int i, boolean z) {
        ...
        if (z || i != this.mCurState) {
            ...
            if (this.mActive != null) {
                ...
                int i2 = 0;
                boolean zHasRunningLoaders2 = false;
                while (i2 < size) {
                    Fragment fragment = this.mAdded.get(i2);
                    moveFragmentToExpectedState(fragment);
                    i2++;
                    zHasRunningLoaders2 = fragment.mLoaderManager != null ? fragment.mLoaderManager.hasRunningLoaders() | zHasRunningLoaders2 : zHasRunningLoaders2;
                }
                ...
                while (i3 < size2) {
                    ...
                    if (fragmentValueAt == null || (!(fragmentValueAt.mRemoving || fragmentValueAt.mDetached) || fragmentValueAt.mIsNewlyAdded)) {
                        zHasRunningLoaders = zHasRunningLoaders2;
                    } else {
                        moveFragmentToExpectedState(fragmentValueAt);
                        if (fragmentValueAt.mLoaderManager != null) {
                            zHasRunningLoaders = fragmentValueAt.mLoaderManager.hasRunningLoaders() | zHasRunningLoaders2;
                        } else {
                            zHasRunningLoaders = zHasRunningLoaders2;
                        }
                    }
                    i3++;
                    zHasRunningLoaders2 = zHasRunningLoaders;
                }
                if (!zHasRunningLoaders2) {
    ...
    private boolean generateOpsForPendingActions(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2) throws Throwable {
        synchronized (this) {
            try {
    ...
    /* JADX WARN: Code duplicated, block: B:45:0x0094 A[LOOP:0: B:44:0x0092->B:45:0x0094, LOOP_END] */
    boolean popBackStackState(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, String str, int i, int i2) {
        ...
        int i3 = -1;
        if (str != null || i >= 0) {
            int size3 = this.mBackStack.size() - 1;
            while (size3 >= 0) {
                BackStackRecord backStackRecord = this.mBackStack.get(size3);
            ...
            if (size3 >= 0) {
                if ((i2 & 1) != 0) {
                    size3--;
                    while (size3 >= 0) {
                        BackStackRecord backStackRecord2 = this.mBackStack.get(size3);
        ...
        } else if (i3 != this.mBackStack.size() - 1) {
            while (size > i3) {
                arrayList.add(this.mBackStack.remove(size));
                arrayList2.add(true);
            }
