...
final class zzik {
    static String zzb(zzih zzihVar, String str) {
    ...
    private static void zzb(zzih zzihVar, StringBuilder sb, int i) {
        ...
        for (String str : treeSet) {
            ...
            if (strReplaceFirst.endsWith("List") && !strReplaceFirst.endsWith("OrBuilderList") && !strReplaceFirst.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zzb(sb, i, zzo(strConcat), zzgz.zzb(method2, zzihVar, new Object[0]));
                }
            }
            if (strReplaceFirst.endsWith("Map") && !strReplaceFirst.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    zzb(sb, i, zzo(strConcat2), zzgz.zzb(method3, zzihVar, new Object[0]));
                }
            }
            ...
            if (((Method) map2.get(strValueOf5.length() != 0 ? "set".concat(strValueOf5) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    Object objZzb = zzgz.zzb(method4, zzihVar, new Object[0]);
                    if (method5 == null) {
                        if (objZzb instanceof Boolean) {
                            zEquals = !((Boolean) objZzb).booleanValue();
                        } else if (objZzb instanceof Integer) {
                            zEquals = ((Integer) objZzb).intValue() == 0;
                        } else if (objZzb instanceof Float) {
                            zEquals = ((Float) objZzb).floatValue() == 0.0f;
                        } else if (objZzb instanceof Double) {
                            zEquals = ((Double) objZzb).doubleValue() == 0.0d;
                        } else if (objZzb instanceof String) {
                            zEquals = objZzb.equals("");
                        } else if (objZzb instanceof zzfr) {
                            zEquals = objZzb.equals(zzfr.zznt);
                        } else if (objZzb instanceof zzih) {
                            zEquals = objZzb == ((zzih) objZzb).zzds();
                        } else {
                            zEquals = (objZzb instanceof Enum) && ((Enum) objZzb).ordinal() == 0;
                        }
                        zBooleanValue = !zEquals;
                    } else {
                        zBooleanValue = ((Boolean) zzgz.zzb(method5, zzihVar, new Object[0])).booleanValue();
                    }
                    if (zBooleanValue) {
                        zzb(sb, i, zzo(strConcat3), objZzb);
                    }
                }
            }
        }
        if (zzihVar instanceof zzgz.zze) {
            Iterator<Map.Entry<FieldDescriptorType, Object>> it = ((zzgz.zze) zzihVar).zzsm.iterator();
            while (it.hasNext()) {
                Map.Entry entry = (Map.Entry) it.next();
                zzb(sb, i, new StringBuilder(13).append("[").append(((zzgz.zzf) entry.getKey()).number).append("]").toString(), entry.getValue());
            }
        }
        if (((zzgz) zzihVar).zzsg != null) {
            ((zzgz) zzihVar).zzsg.zzb(sb, i);
        }
    }
    ...
    static final void zzb(StringBuilder sb, int i, String str, Object obj) {
        ...
        if (obj instanceof String) {
            sb.append(": \"").append(zzjm.zze(zzfr.zzj((String) obj))).append('\"');
            return;
        }
        if (obj instanceof zzfr) {
            sb.append(": \"").append(zzjm.zze((zzfr) obj)).append('\"');
            return;
        }
