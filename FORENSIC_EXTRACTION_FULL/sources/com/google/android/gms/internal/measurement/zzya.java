...
public final class zzya {
    ...
    public static int zzb(int i, zzyi zzyiVar) {
        int iZzbd = zzbd(i);
        int iZzvx = zzyiVar.zzvx();
        return iZzbd + iZzvx + zzbl(iZzvx);
    }
    ...
    public final void zza(int i, double d) throws IOException {
        ...
        this.zzbut.putLong(jDoubleToLongBits);
    }
    ...
    public final void zza(int i, float f) throws IOException {
        ...
        this.zzbut.putInt(iFloatToIntBits);
    }
    ...
    public final void zzb(int i, String str) throws IOException {
        zzc(i, 2);
        try {
            int iZzbl = zzbl(str.length());
            if (iZzbl != zzbl(str.length() * 3)) {
                zzcd(zza(str));
                zzd(str, this.zzbut);
                return;
            }
            int iPosition = this.zzbut.position();
            if (this.zzbut.remaining() < iZzbl) {
                throw new zzyb(iZzbl + iPosition, this.zzbut.limit());
            }
            this.zzbut.position(iPosition + iZzbl);
            zzd(str, this.zzbut);
            int iPosition2 = this.zzbut.position();
            this.zzbut.position(iPosition);
            zzcd((iPosition2 - iPosition) - iZzbl);
            this.zzbut.position(iPosition2);
        } catch (BufferOverflowException e) {
            zzyb zzybVar = new zzyb(this.zzbut.position(), this.zzbut.limit());
            zzybVar.initCause(e);
            throw zzybVar;
        }
    }
    ...
    public final void zze(int i, zzvv zzvvVar) throws IOException {
        zztv zztvVarZzyz = zzyz();
        zztvVarZzyz.zza(i, zzvvVar);
        zztvVarZzyz.flush();
        this.zzceu = this.zzbut.position();
    }
    ...
    public final void zzza() {
        if (this.zzbut.remaining() != 0) {
            throw new IllegalStateException(String.format("Did not write as much data as expected, %s bytes remaining.", Integer.valueOf(this.zzbut.remaining())));
        }
    }
}
