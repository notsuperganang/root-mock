...
interface zzwk {
    ...
    <T> T zza(zzwl<T> zzwlVar, zzub zzubVar) throws IOException;

    <T> void zza(List<T> list, zzwl<T> zzwlVar, zzub zzubVar) throws IOException;

    <K, V> void zza(Map<K, V> map, zzvo<K, V> zzvoVar, zzub zzubVar) throws IOException;

    @Deprecated
    <T> T zzb(zzwl<T> zzwlVar, zzub zzubVar) throws IOException;

    @Deprecated
    <T> void zzb(List<T> list, zzwl<T> zzwlVar, zzub zzubVar) throws IOException;
