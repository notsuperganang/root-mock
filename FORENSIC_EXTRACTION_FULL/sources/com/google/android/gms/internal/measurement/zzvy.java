...
final class zzvy {
    static String zza(zzvv zzvvVar, String str) {
    ...
    private static void zza(zzvv zzvvVar, StringBuilder sb, int i) {
        boolean zBooleanValue;
        boolean zEquals;
        HashMap map = new HashMap();
        HashMap map2 = new HashMap();
        TreeSet<String> treeSet = new TreeSet();
        for (Method method : zzvvVar.getClass().getDeclaredMethods()) {
        ...
        for (String str : treeSet) {
            ...
            if (strReplaceFirst.endsWith("List") && !strReplaceFirst.endsWith("OrBuilderList") && !strReplaceFirst.equals("List")) {
                ...
                if (method2 != null && method2.getReturnType().equals(List.class)) {
                    zzb(sb, i, zzgf(strConcat), zzuo.zza(method2, zzvvVar, new Object[0]));
                }
            }
            if (strReplaceFirst.endsWith("Map") && !strReplaceFirst.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    zzb(sb, i, zzgf(strConcat2), zzuo.zza(method3, zzvvVar, new Object[0]));
                }
            }
            ...
            if (((Method) map2.get(strValueOf5.length() != 0 ? "set".concat(strValueOf5) : new String("set"))) != null) {
                ...
                if (method4 != null) {
                    Object objZza = zzuo.zza(method4, zzvvVar, new Object[0]);
                    if (method5 == null) {
                        ...
                        } else if (objZza instanceof zzte) {
                            zEquals = objZza.equals(zzte.zzbts);
                        } else if (objZza instanceof zzvv) {
                            zEquals = objZza == ((zzvv) objZza).zzwj();
                        } else {
                            zEquals = (objZza instanceof Enum) && ((Enum) objZza).ordinal() == 0;
                        }
                        zBooleanValue = !zEquals;
                    } else {
                        zBooleanValue = ((Boolean) zzuo.zza(method5, zzvvVar, new Object[0])).booleanValue();
                    }
                    if (zBooleanValue) {
                        zzb(sb, i, zzgf(strConcat3), objZza);
                    }
                }
            }
        }
        if (zzvvVar instanceof zzuo.zzc) {
            Iterator<Map.Entry<FieldDescriptorType, Object>> it = ((zzuo.zzc) zzvvVar).zzbyl.iterator();
            if (it.hasNext()) {
                ((Map.Entry) it.next()).getKey();
                throw new NoSuchMethodError();
            }
        }
        if (((zzuo) zzvvVar).zzbyf != null) {
            ((zzuo) zzvvVar).zzbyf.zzb(sb, i);
        }
    }
    ...
    static final void zzb(StringBuilder sb, int i, String str, Object obj) {
        ...
        if (obj instanceof String) {
            sb.append(": \"").append(zzwz.zzd(zzte.zzga((String) obj))).append('\"');
            return;
        }
        if (obj instanceof zzte) {
            sb.append(": \"").append(zzwz.zzd((zzte) obj)).append('\"');
            return;
        }
