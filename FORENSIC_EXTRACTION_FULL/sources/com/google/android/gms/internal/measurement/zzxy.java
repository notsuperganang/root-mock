...
interface zzxy {
    ...
    void zza(int i, zzte zzteVar) throws IOException;

    <K, V> void zza(int i, zzvo<K, V> zzvoVar, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzwl zzwlVar) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzwl zzwlVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzwl zzwlVar) throws IOException;
    ...
    @Deprecated
    void zzb(int i, List<?> list, zzwl zzwlVar) throws IOException;
