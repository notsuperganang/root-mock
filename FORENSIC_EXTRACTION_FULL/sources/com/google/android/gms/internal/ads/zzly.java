    ...
    public final void zza(zzlw zzlwVar) {
        try {
            if (this.zzasy == null) {
                ...
                this.zzasy = "search_v2".equals(zzjnVarZza.zzarb) ? (zzks) zzjr.zza(context, false, (zzjr.zza) new zzjt(zzkb.zzig(), context, zzjnVarZza, this.zzye)) : (zzks) zzjr.zza(context, false, (zzjr.zza) new zzjs(zzkb.zzig(), context, zzjnVarZza, this.zzye, this.zzast));
