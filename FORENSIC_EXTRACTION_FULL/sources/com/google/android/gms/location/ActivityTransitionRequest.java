...
public class ActivityTransitionRequest extends AbstractSafeParcelable {
    ...
    public int hashCode() {
        int iHashCode = this.zzl.hashCode();
        return (((this.tag != null ? this.tag.hashCode() : 0) + (iHashCode * 31)) * 31) + (this.zzm != null ? this.zzm.hashCode() : 0);
    }
    ...
    public String toString() {
        ...
        return new StringBuilder(String.valueOf(strValueOf).length() + 61 + String.valueOf(str).length() + String.valueOf(strValueOf2).length()).append("ActivityTransitionRequest [mTransitions=").append(strValueOf).append(", mTag='").append(str).append('\'').append(", mClients=").append(strValueOf2).append(']').toString();
    }
