...
public final class zzaw extends zzfm {
    ...
    public zzaw(zzfn zzfnVar) {
        super(zzfnVar);
        this.zzamo = Build.VERSION.SDK_INT < 19 ? new zzfy() : null;
    }
    ...
    protected final HttpURLConnection zzb(URL url) throws IOException {
        ...
        if (this.zzamo != null && (uRLConnectionOpenConnection instanceof HttpsURLConnection)) {
            ((HttpsURLConnection) uRLConnectionOpenConnection).setSSLSocketFactory(this.zzamo);
        }
