...
public final class WakeLockEvent extends StatsEvent {
    ...
    public final String zzv() {
        ...
        int i = this.zzft;
        String strJoin = this.zzfu == null ? "" : TextUtils.join(",", this.zzfu);
        int i2 = this.zzfx;
        String str2 = this.zzfr == null ? "" : this.zzfr;
        String str3 = this.zzfy == null ? "" : this.zzfy;
        float f = this.zzfz;
        String str4 = this.zzfs == null ? "" : this.zzfs;
        return new StringBuilder(String.valueOf(str).length() + 45 + String.valueOf(strJoin).length() + String.valueOf(str2).length() + String.valueOf(str3).length() + String.valueOf(str4).length()).append("\t").append(str).append("\t").append(i).append("\t").append(strJoin).append("\t").append(i2).append("\t").append(str2).append("\t").append(str3).append("\t").append(f).append("\t").append(str4).toString();
    }
}
